...
class SessionManagerWindowController: NSWindowController {
    ...
    init() {
        ...
        // 使用SwiftUI视图
        let contentView = SessionManagerView()
        ...
        print("[DEBUG] SessionManagerWindowController initialized")
    ...
    func show() {
        print("[DEBUG] Showing Session Manager window...")
        ...
        DispatchQueue.main.asyncAfter(deadline: .now() + 0.1) {
            ...
            print("[DEBUG] First activation attempt for Session Manager")
        }
        ...
        DispatchQueue.main.asyncAfter(deadline: .now() + 0.3) {
            ...
            print("[DEBUG] Session Manager window shown and activated")
