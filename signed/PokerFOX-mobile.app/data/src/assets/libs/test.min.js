    ...
    !function (A, e) {
      ...
      return B = [function (A, e, B) {
        ...
        g((B = Q).prototype, [{
          ...
          value: function () {
            var e = this;
            return E() ? navigator.wakeLock.request("screen").then(function (A) {
              e._wakeLock = A, e.enabled = !0, console.log("Wake Lock active."), e._wakeLock.addEventListener("release", function () {
                console.log("Wake Lock released.");
              });
            }).catch(function (A) {
              throw e.enabled = !1, console.error(A.name + ", " + A.message), A;
            ...
            }, 15e3), this.enabled = !0, Promise.resolve()) : this.noSleepVideo.play().then(function (A) {
              return e.enabled = !0, A;
            }).catch(function (A) {
              throw e.enabled = !1, A;
            });
          }
      ...
      }], g = {}, o.m = B, o.c = g, o.d = function (A, e, B) {
        ...
        if (o.r(B), Object.defineProperty(B, "default", {
          enumerable: !0,
          value: e
        }), 2 & A && "string" != typeof e) for (var g in e) o.d(B, g, function (A) {
          return e[A];
        }.bind(null, g));
        return B;
      }, o.n = function (A) {
      ...
      function o(A) {
        ...
        return (g[A] || (e = g[A] = {
          ...
          l: !1,
          exports: {}
        }, B[A].call(e.exports, e, e.exports, o), e.l = !0, e)).exports;
      }
