(function (root) {
  ...
  (function () {
    ...
    function e(n) {
      for (var a = [], i = n.length, u = [], e = 0; e <= i; e++) u.push(!0);

      return o(0, n, [], a, u), a;
    }

    function o(e, g, h, t, r) {
      var n = g.length;
      if (e !== n) for (var c = e; c < n; c++) !function () {
        var i,
            u = g.substring(e, c + 1),
            n = !1;
        a.some(function (n) {
          return 0 === n.indexOf(u);
        }) && !g[c + 1] && r[c + 1] ? (1 === u.length ? h.push(u) : (i = [], a.forEach(function (n) {
          0 === n.indexOf(u) && i.push(n);
        }), h.push(i)), n = !0) : -1 !== a.indexOf(u) && r[c + 1] && (h.push(u), n = !0), n && (n = t.length, o(c + 1, g, h, t, r), t.length === n && (r[c + 1] = !1), h.pop());
      }();else t.push(h.join(" "));
    }

    function r(n, a, i, u) {
      var e;
      return !!n && ((e = n.split(" ")).forEach(function (n) {
        0 < n.length && u && e.push(n.charAt(0));
      }), i ? e.some(function (n) {
    ...
    function g(a, o) {
      ...
      var g,
          t = a.indexOf(o);
      return -1 !== t ? [t, t + o.length - 1] : h(a.split(""), [o.split("")], o) || h(function (n) {
        for (var a = [], i = 0, e = n.length; i < e; i++) {
          var o = n.charAt(i);
          a.push(u[o] || o);
        }

        return a;
      }(a), i[o] || (g = [], e(t = o).forEach(function (n) {
        var a = n.split(" "),
            i = a.length - 1;
        a[i].indexOf(",") ? a[i].split(",").forEach(function (n) {
          a.splice(i, 1, n), g.push(JSON.parse(JSON.stringify(a)));
        }) : g.push(a);
      }), 0 !== g.length && g[0].length === t.length || g.push(t.split("")), i = n({}, t, g), g), o);
    }
    ...
    function h(n, a, i) {
      for (var u = 0; n.length > u; u++) for (var e = 0; a.length > e; e++) {
        ...
        if (n.length >= g) {
          for (; o.length > c; c++) if (0 === c && " " === n[u + c + s]) s += 1, --c;else if (" " === n[u + c + l]) l += 1, --c;else if (!r(n[u + c + l], o[c], !n[u + c + 1] || !o[c + 1], h)) {
            t = !1;
            break;
          }

          if (t) return [u + s, l + u + c - 1];
        }
      }
    ...
    var t = {
      match: function (e) {
        var o = {},
            h = ["ju", "jun", "jue", "juan", "qu", "qun", "que", "xuan", "xu", "xue", "yu", "yuan", "yue", "yun", "nve", "lve"];
        return Object.keys(e).forEach(function (n) {
          var i;
          o[n] = e[n], a.push(n), h.includes(n) && (i = -1 !== (i = n).indexOf("u") ? i.replace("u", "v") : i.replace("v", "u"), o[i] = e[n], a.push(i));
        }), u = function (n) {
          var a,
              i = {};

          for (a in n) for (var u = n[a], e = 0, o = u.length; e < o; e++) i[u[e]] = i[u[e]] ? i[u[e]] + " " + a : a;
        ...
        zhe: "喆乇仛厇哲啠喆嗫嗻嘀嚞囁埑堵嫬庶悊慹扸折摂摄摺攝斥晢晣杔柘棏樀樜歽浙淛潪着矺砓磔籷粍者耷聂聑聶著蔗虴蛰蜇蟄蟅袩褚褶襵詟謫謶謺讁讋谪赭軼輒輙轍轶辄辙这這適遮銸鍺锗陬馲驝鮿鷓鷙鸷鹧",
        ...
        cui: "乼伜倅催凗啐啛墔察崒崔崪嶉忰悴慛摧椊榱槯毳淬漼濢焠熣獕琗璀疩瘁皠磪竁粋粹紣綷縗繀缞翆翠脃脆脺膬膵臎萃衰襊趡踤鏙隹顇",
        ...
        ben: "倴喯坌夯夲奔奙捹撪本桳楍泍渀炃燌犇獖畚笨翉苯蟦賁贲輽逩錛鐼锛",
